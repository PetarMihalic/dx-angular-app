...
export class ThemeService {
    ...
    getThemeData(){
        return [
            { text: "Orange Light", value: "orange.light", ImageSrc: "assets/icons/MaterialOrangeLight.svg"},
            { text: "Orange Dark", value: "orange.dark", ImageSrc: "assets/icons/MaterialOrangeDark.svg" },
            { text: "Blue Light", value: "blue.light", ImageSrc: "assets/icons/MaterialBlueLight.svg" },
            { text: "Blue Dark", value: "blue.dark", ImageSrc: "assets/icons/MaterialBlueDark.svg" }
        ]
    }
